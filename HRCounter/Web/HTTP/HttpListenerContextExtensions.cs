...
public static class HttpListenerContextExtensions
{
    ...
    public static async Task SendResponseAsync(this HttpListenerContext context, string text, string contentType = "text/plain",
    ...
    public static void SendResponse(this HttpListenerContext context, string text, string contentType = "text/plain",
        HttpStatusCode code = HttpStatusCode.OK)
    {
        var response = context.Response;
        response.StatusCode = (int)code;
    ...
    {
        context.SendResponse(json, "application/json");
    }

    public static async Task SendJsonResponseAsync(this HttpListenerContext context, string json)
    {
        await context.SendResponseAsync(json, "application/json");
    }
}
